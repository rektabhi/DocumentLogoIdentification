...
def process_image(path):
    ...
    return np.asarray(text_im)
    # text_im.save(out_path)
    # print('%s -> %s' % (path, out_path))

# loc = "C:/Users/Abhishek Bansal/Desktop/Image Processing/Logo Identification/Logo.png"
# loc2 = "C:/Users/Abhishek Bansal/Desktop/Image Processing/Logo Identification/Logo111111111111.png"

# process_image(loc, loc2)
